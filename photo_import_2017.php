...
$fileFolder="coe/BE_CSE_2017";  // location of the application and the image directory.
		...
		if(strlen($fileName)== 12)
			{
				...
				$data1=$row["id"]."_3";
					...
					if($row["reg"] == substr($fileName,0,8))
		           {
				    rename($directory . substr($fileName,0,8).".jpg", $directory . $row["file_name"].".jpg");
